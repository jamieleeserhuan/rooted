...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    const bgVec4 = new THREE.Vector4(0, 0, 0, 0); // transparent background for modern blending
    ...
    class MouseClass {
      ...
      _onTouchEnd: (ev: TouchEvent | MouseEvent) => void;
      _onDocumentLeave: (ev: Event) => void;
...
`;
  ...
  return <div ref={mountRef} className={`liquid-ether-container ${className || ''}`} style={style} id="rooted-fluid-canvas-container" />;
}
